        ...
        for(int rowNum=startRowNum;rowNum<=totalRows;rowNum++) {
        	...
        	for(int colNum=startColumnNum;colNum<totalCols;colNum++) {
                ...
                if(cellObj==null) {		                	
                	...
                	case 57:  dataObj.setFristAddressline(cellObj.getStringCellValue()); break;
                	case 58:  dataObj.setSecAddressline(cellObj.getStringCellValue()); break;
                	case 59:  dataObj.setBusinessType(cellObj.getStringCellValue()); break;
                	case 60:  dataObj.setInspectorName(cellObj.getStringCellValue()); break;
                	case 61:  dataObj.setLocationCity(cellObj.getStringCellValue()); break;
                	case 62:  dataObj.setLocationZipCode(cellObj.getStringCellValue()); break;
                	case 63:  dataObj.setBusinessPhone(cellObj.getStringCellValue()); break;
                	case 64:  dataObj.setBusinessEmail(cellObj.getStringCellValue()); break;
                	case 65:  dataObj.setLicenseType(cellObj.getStringCellValue()); break;
                	case 66:  dataObj.setLicenseNumber(cellObj.getStringCellValue()); break;
                	case 67:  dataObj.setIndustrialPercent(cellObj.getStringCellValue()); break;
                	case 68:  dataObj.setCommercialPercent(cellObj.getStringCellValue()); break;
                	case 69:  dataObj.setResidentialPercent(cellObj.getStringCellValue()); break;
                	case 70:  dataObj.setNewConstructionPercent(cellObj.getStringCellValue()); break;
                	case 71:  dataObj.setRoomAdditionsPercent(cellObj.getStringCellValue()); break;
                	case 72:  dataObj.setRemodelingPercent(cellObj.getStringCellValue()); break;
                	case 73:  dataObj.setRepairorServicePercent(cellObj.getStringCellValue()); break;
                	case 74:  dataObj.setSEMake(cellObj.getStringCellValue()); break;
                	case 75:  dataObj.setSEModel(cellObj.getStringCellValue()); break;
                	case 76:  dataObj.setSESerialNo(cellObj.getStringCellValue()); break;
                	case 77:  dataObj.setSELossPayee(cellObj.getStringCellValue()); break;
                	case 78:  dataObj.setSEName(cellObj.getStringCellValue()); break;
                	case 79:  dataObj.setSEAddr(cellObj.getStringCellValue()); break;
                	case 80:  dataObj.setSECity(cellObj.getStringCellValue()); break;
                	case 81:  dataObj.setSEZip(cellObj.getStringCellValue()); break;
                	case 82:  dataObj.setAgentNotes(cellObj.getStringCellValue()); break;
                	case 83:  dataObj.setAgentMessages(cellObj.getStringCellValue()); break;
                	case 84:  dataObj.setUWModifyPerm(cellObj.getStringCellValue()); break;
                	case 85:  dataObj.setUWModifyRiskLPerm(cellObj.getStringCellValue()); break;
                	case 86:  dataObj.setUWModifyState(cellObj.getStringCellValue()); break;
                	case 87:  dataObj.setUWModifyCity(cellObj.getStringCellValue()); break;
                	case 88:  dataObj.setUWModifyZip(cellObj.getStringCellValue()); break;
                	case 89:  dataObj.setUWModifyCounty(cellObj.getStringCellValue()); break;
                	case 90:  dataObj.setUWModifyBName(cellObj.getStringCellValue()); break;
                	case 91:  dataObj.setUWModifyPremFLName(cellObj.getStringCellValue()); break;
                	case 92:  dataObj.setUWModifyFName(cellObj.getStringCellValue()); break;
                	case 93:  dataObj.setUWModifyLName(cellObj.getStringCellValue()); break;
                	case 94:  dataObj.setUWModifyLL(cellObj.getStringCellValue()); break;
                	case 95:  dataObj.setUWModifyDeductible(cellObj.getStringCellValue()); break;
                	case 96:  dataObj.setUWModifyAI(cellObj.getStringCellValue()); break;
                	case 97:  dataObj.setUWAIFCG1001(cellObj.getStringCellValue()); break;
                	case 98:  dataObj.setUWAICG2010(cellObj.getStringCellValue()); break;
                	case 99:  dataObj.setUWAICG2037(cellObj.getStringCellValue()); break;
                	case 100: dataObj.setUWAICG1019(cellObj.getStringCellValue()); break;
                	case 101: dataObj.setUWAICG2404(cellObj.getStringCellValue()); break;
                	case 102: dataObj.setUWAICG2012(cellObj.getStringCellValue()); break;
                	case 103: dataObj.setUWAICG2029(cellObj.getStringCellValue()); break;
                	case 104: dataObj.setUWAICG2028(cellObj.getStringCellValue()); break;
                	case 105: dataObj.setUWAICG2024(cellObj.getStringCellValue()); break;
                	case 106: dataObj.setUWAICG2005(cellObj.getStringCellValue()); break;
                	case 107: dataObj.setUWAICG2011(cellObj.getStringCellValue()); break;
                	case 108: dataObj.setUWAICG2007(cellObj.getStringCellValue()); break;
                	case 109: dataObj.setUWAICG2026(cellObj.getStringCellValue()); break;
                	case 110: dataObj.setUWModifyWS(cellObj.getStringCellValue()); break;
                	case 111: dataObj.setUWModifyIM(cellObj.getStringCellValue()); break;
                	case 112: dataObj.setUWModifyInstallationFloater(cellObj.getStringCellValue()); break;
                	case 113: dataObj.setUWModifyContractorsHandTools(cellObj.getStringCellValue()); break;
                	case 114: dataObj.setUWModifyRentedorLeasedEquipment(cellObj.getStringCellValue()); break;
                	case 115: dataObj.setUWModifyScheduleEquipment(cellObj.getStringCellValue()); break;
                	case 116: dataObj.setUWModifyScheduleEquipmentDescription(cellObj.getStringCellValue()); break;
                	case 117: dataObj.setUWModifyScheduleEquipmentAmount(cellObj.getStringCellValue()); break;
                	case 118: dataObj.setUWModifyClassPay(cellObj.getStringCellValue()); break;
                	case 119: dataObj.setUWModifyMainClasscode(cellObj.getStringCellValue()); break;
                	case 120: dataObj.setUWModifySubClasscode(cellObj.getStringCellValue()); break;
                	case 121: dataObj.setUWModifyActiveOwner(cellObj.getStringCellValue()); break;
                	case 122: dataObj.setUWModifyExpectedGross(cellObj.getStringCellValue()); break;
                	case 123: dataObj.setUWModifySubContractorGross(cellObj.getStringCellValue()); break;
                	case 124: dataObj.setUWModifyUnSubContractorGross(cellObj.getStringCellValue()); break;
                	case 125: dataObj.setUWModifyAdministrativeEmployee(cellObj.getStringCellValue()); break;
                	case 126: dataObj.setUWModifyAdministrativeEmployeeGrossAtm(cellObj.getStringCellValue()); break;
                	case 127: dataObj.setUWModifySalesEmployees(cellObj.getStringCellValue()); break;
                	case 128: dataObj.setUWModifySalesEmployeesGrossAtm(cellObj.getStringCellValue()); break;
                	case 129: dataObj.setUWModifyOtherEmployees(cellObj.getStringCellValue()); break;
                	case 130: dataObj.setUWModifyOtherEmployeesGrossAtm(cellObj.getStringCellValue()); break;
                	case 131: dataObj.setUWModifyClassSpecificQ(cellObj.getStringCellValue()); break;
                	case 132: dataObj.setUWRateType(cellObj.getStringCellValue()); break;
                	case 133: dataObj.setUWModifiedRates(cellObj.getStringCellValue()); break;
                	case 134: dataObj.setUWNotes(cellObj.getStringCellValue()); break;
                	case 135: dataObj.setUWMessages(cellObj.getStringCellValue()); break;
                	case 136: dataObj.setUWQuoteStatus(cellObj.getStringCellValue()); break;
                	case 137: dataObj.setUWReferralRemark(cellObj.getStringCellValue()); break;
                	case 138: dataObj.setActionMessages(cellObj.getStringCellValue()); break;
                	case 139: dataObj.setPaymentOption(cellObj.getStringCellValue()); break;
                	case 140: dataObj.setDepositPaymentMethod(cellObj.getStringCellValue()); break;
                	case 141: dataObj.setCreditCardNumber(cellObj.getStringCellValue()); break;
                	case 142: dataObj.setCVVNumber(cellObj.getStringCellValue()); break;
                	
                	//-----------------------------------------------------------------
                	
                	case 143: dataObj.setScriptStatus(cellObj.getStringCellValue()); break;   
                	case 144: dataObj.setInsuredName(cellObj.getStringCellValue()); break;
                	case 145: dataObj.setQuoteDate(cellObj.getStringCellValue()); break;
                	case 146: dataObj.setQuoteNo(cellObj.getStringCellValue()); break;
                	case 147: dataObj.setCountyCode(cellObj.getStringCellValue()); break;
                	case 148: dataObj.setFWCIPremium(cellObj.getStringCellValue()); break;
                	case 149: dataObj.setFWCIMGAPolicyFee(cellObj.getStringCellValue()); break;
                	case 150: dataObj.setCBPremium(cellObj.getStringCellValue()); break;
                	case 151: dataObj.setCBMGAPolicyFee(cellObj.getStringCellValue()); break;
                	case 152: dataObj.setFWCIProducerFee(cellObj.getStringCellValue()); break;
                	case 153: dataObj.setCBProducerFee(cellObj.getStringCellValue()); break;
                	case 154: dataObj.setPolicyNo(cellObj.getStringCellValue()); break;
