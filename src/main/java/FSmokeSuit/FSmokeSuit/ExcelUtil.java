        ...
        for(int rowNum=startRowNum;rowNum<=totalRows;rowNum++) {
        	...
        	for(int colNum=startColumnNum;colNum<totalCols;colNum++) {
                ...
                if(cellObj==null) {		                	
                	...
                	case 87:  dataObj.setUWModifyClassPay(cellObj.getStringCellValue()); break;
                	case 88:  dataObj.setUWModifyMainClasscode(cellObj.getStringCellValue()); break;
                	case 89:  dataObj.setUWModifySubClasscode(cellObj.getStringCellValue()); break;
                	case 90:  dataObj.setUWModifyActiveOwner(cellObj.getStringCellValue()); break;
                	case 91:  dataObj.setUWModifyExpectedGross(cellObj.getStringCellValue()); break;
                	case 92:  dataObj.setUWModifySubContractorGross(cellObj.getStringCellValue()); break;
                	case 93:  dataObj.setUWModifyUnSubContractorGross(cellObj.getStringCellValue()); break;
                	case 94:  dataObj.setUWModifyClassSpecificQ(cellObj.getStringCellValue()); break;
                	case 95:  dataObj.setUWRateType(cellObj.getStringCellValue()); break;
                	case 96:  dataObj.setUWModifiedRates(cellObj.getStringCellValue()); break;
                	case 97:  dataObj.setUWNotes(cellObj.getStringCellValue()); break;
                	case 98:  dataObj.setUWMessages(cellObj.getStringCellValue()); break;
                	case 99:  dataObj.setUWQuoteStatus(cellObj.getStringCellValue()); break;
                	case 100:  dataObj.setUWReferralRemark(cellObj.getStringCellValue()); break;
                	case 101:  dataObj.setTypeofCompany(cellObj.getStringCellValue()); break;
                	case 102:  dataObj.setPaymentOption(cellObj.getStringCellValue()); break;
                	case 103: dataObj.setDepositPaymentMethod(cellObj.getStringCellValue()); break;
                	
                	//-----------------------------------------------------------------
                	
                	case 104: dataObj.setScriptStatus(cellObj.getStringCellValue()); break;   
                	case 105: dataObj.setInsuredName(cellObj.getStringCellValue()); break;
                	case 106: dataObj.setQuoteDate(cellObj.getStringCellValue()); break;
                	case 107: dataObj.setQuoteNo(cellObj.getStringCellValue()); break;
                	case 108: dataObj.setCountyCode(cellObj.getStringCellValue()); break;
                	case 109: dataObj.setFWCIPremium(cellObj.getStringCellValue()); break;
                	case 110: dataObj.setFWCIMGAPolicyFee(cellObj.getStringCellValue()); break;
                	case 111: dataObj.setCBPremium(cellObj.getStringCellValue()); break;
                	case 112: dataObj.setCBMGAPolicyFee(cellObj.getStringCellValue()); break;
                	case 113: dataObj.setFWCIProducerFee(cellObj.getStringCellValue()); break;
                	case 114: dataObj.setCBProducerFee(cellObj.getStringCellValue()); break;
                	case 115: dataObj.setPolicyNo(cellObj.getStringCellValue()); break;
