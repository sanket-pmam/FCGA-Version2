        ...
        for(int rowNum=startRowNum;rowNum<=totalRows;rowNum++) {
        	...
        	for(int colNum=startColumnNum;colNum<totalCols;colNum++) {
                ...
                if(cellObj==null) {		                	
                	...
                	case 55:  dataObj.setActiveOwner(cellObj.getNumericCellValue()); break;
                	case 56:  dataObj.setLicenseType(cellObj.getStringCellValue()); break;
                	case 57:  dataObj.setLicenseNumber(cellObj.getStringCellValue()); break;
                	case 58:  dataObj.setIndustrialPercent(cellObj.getStringCellValue()); break;
                	case 59:  dataObj.setCommercialPercent(cellObj.getStringCellValue()); break;
                	case 60:  dataObj.setResidentialPercent(cellObj.getStringCellValue()); break;
                	case 61:  dataObj.setNewConstructionPercent(cellObj.getStringCellValue()); break;
                	case 62:  dataObj.setRoomAdditionsPercent(cellObj.getStringCellValue()); break;
                	case 63:  dataObj.setRemodelingPercent(cellObj.getStringCellValue()); break;
                	case 64:  dataObj.setRepairorServicePercent(cellObj.getStringCellValue()); break;
                	case 65:  dataObj.setSEMake(cellObj.getStringCellValue()); break;
                	case 66:  dataObj.setSEModel(cellObj.getStringCellValue()); break;
                	case 67:  dataObj.setSESerialNo(cellObj.getStringCellValue()); break;
                	case 68:  dataObj.setSELossPayee(cellObj.getStringCellValue()); break;
                	case 69:  dataObj.setSEName(cellObj.getStringCellValue()); break;
                	case 70:  dataObj.setSEAddr(cellObj.getStringCellValue()); break;
                	case 71:  dataObj.setSECity(cellObj.getStringCellValue()); break;
                	case 72:  dataObj.setSEZip(cellObj.getStringCellValue()); break;
                	case 73:  dataObj.setAgentNotes(cellObj.getStringCellValue()); break;
                	case 74:  dataObj.setAgentMessages(cellObj.getStringCellValue()); break;
                	case 75:  dataObj.setProducerFee(cellObj.getStringCellValue()); break;
                	case 76:  dataObj.setUWModifyPerm(cellObj.getStringCellValue()); break;
                	case 77:  dataObj.setUWModifyRiskLPerm(cellObj.getStringCellValue()); break;
                	case 78:  dataObj.setUWModifyState(cellObj.getStringCellValue()); break;
                	case 79:  dataObj.setUWModifyCity(cellObj.getStringCellValue()); break;
                	case 80:  dataObj.setUWModifyZip(cellObj.getStringCellValue()); break;
                	case 81:  dataObj.setUWModifyCounty(cellObj.getStringCellValue()); break;
                	case 82:  dataObj.setUWModifyBName(cellObj.getStringCellValue()); break;
                	case 83:  dataObj.setUWModifyFName(cellObj.getStringCellValue()); break;
                	case 84:  dataObj.setUWModifyLName(cellObj.getStringCellValue()); break;
                	case 85:  dataObj.setUWModifyLL(cellObj.getStringCellValue()); break;
                	case 86:  dataObj.setUWModifyDeductible(cellObj.getStringCellValue()); break;
                	case 87:  dataObj.setUWModifyAI(cellObj.getStringCellValue()); break;
                	case 88:  dataObj.setUWAIFCG1001(cellObj.getStringCellValue()); break;
                	case 89:  dataObj.setUWAICG2010(cellObj.getStringCellValue()); break;
                	case 90:  dataObj.setUWAICG2037(cellObj.getStringCellValue()); break;
                	case 91:  dataObj.setUWAICG1019(cellObj.getStringCellValue()); break;
                	case 92:  dataObj.setUWAICG2404(cellObj.getStringCellValue()); break;
                	case 93:  dataObj.setUWAICG2012(cellObj.getStringCellValue()); break;
                	case 94:  dataObj.setUWAICG2029(cellObj.getStringCellValue()); break;
                	case 95:  dataObj.setUWAICG2028(cellObj.getStringCellValue()); break;
                	case 96:  dataObj.setUWAICG2024(cellObj.getStringCellValue()); break;
                	case 97:  dataObj.setUWAICG2005(cellObj.getStringCellValue()); break;
                	case 98:  dataObj.setUWAICG2011(cellObj.getStringCellValue()); break;
                	case 99:  dataObj.setUWAICG2007(cellObj.getStringCellValue()); break;
                	case 100: dataObj.setUWAICG2026(cellObj.getStringCellValue()); break;
                	case 101: dataObj.setUWModifyWS(cellObj.getStringCellValue()); break;
                	case 102: dataObj.setUWModifyIM(cellObj.getStringCellValue()); break;
                	case 103: dataObj.setUWModifyInstallationFloater(cellObj.getStringCellValue()); break;
                	case 104: dataObj.setUWModifyContractorsHandTools(cellObj.getStringCellValue()); break;
                	case 105: dataObj.setUWModifyRentedorLeasedEquipment(cellObj.getStringCellValue()); break;
                	case 106: dataObj.setUWModifyScheduleEquipment(cellObj.getStringCellValue()); break;
                	case 107: dataObj.setUWModifyScheduleEquipmentDescription(cellObj.getStringCellValue()); break;
                	case 108: dataObj.setUWModifyScheduleEquipmentAmount(cellObj.getStringCellValue()); break;
                	case 109: dataObj.setUWModifyClassPay(cellObj.getStringCellValue()); break;
                	case 110: dataObj.setUWModifyMainClasscode(cellObj.getStringCellValue()); break;
                	case 111: dataObj.setUWModifySubClasscode(cellObj.getStringCellValue()); break;
                	case 112: dataObj.setUWModifyActiveOwner(cellObj.getStringCellValue()); break;
                	case 113: dataObj.setUWModifyExpectedGross(cellObj.getStringCellValue()); break;
                	case 114: dataObj.setUWModifySubContractorGross(cellObj.getStringCellValue()); break;
                	case 115: dataObj.setUWModifyUnSubContractorGross(cellObj.getStringCellValue()); break;
                	case 116: dataObj.setUWModifyClassSpecificQ(cellObj.getStringCellValue()); break;
                	case 117: dataObj.setUWRateType(cellObj.getStringCellValue()); break;
                	case 118: dataObj.setUWModifiedRates(cellObj.getStringCellValue()); break;
                	case 119: dataObj.setUWNotes(cellObj.getStringCellValue()); break;
                	case 120: dataObj.setUWMessages(cellObj.getStringCellValue()); break;
                	case 121: dataObj.setUWQuoteStatus(cellObj.getStringCellValue()); break;
                	case 122: dataObj.setUWReferralRemark(cellObj.getStringCellValue()); break;
                	case 123: dataObj.setTypeofCompany(cellObj.getStringCellValue()); break;
                	case 124: dataObj.setPaymentOption(cellObj.getStringCellValue()); break;
                	case 125: dataObj.setDepositPaymentMethod(cellObj.getStringCellValue()); break;
                	
                	//-----------------------------------------------------------------
                	
                	case 126: dataObj.setScriptStatus(cellObj.getStringCellValue()); break;   
                	case 127: dataObj.setInsuredName(cellObj.getStringCellValue()); break;
                	case 128: dataObj.setQuoteDate(cellObj.getStringCellValue()); break;
                	case 129: dataObj.setQuoteNo(cellObj.getStringCellValue()); break;
                	case 130: dataObj.setCountyCode(cellObj.getStringCellValue()); break;
                	case 131: dataObj.setFWCIPremium(cellObj.getStringCellValue()); break;
                	case 132: dataObj.setFWCIMGAPolicyFee(cellObj.getStringCellValue()); break;
                	case 133: dataObj.setCBPremium(cellObj.getStringCellValue()); break;
                	case 134: dataObj.setCBMGAPolicyFee(cellObj.getStringCellValue()); break;
                	case 135: dataObj.setFWCIProducerFee(cellObj.getStringCellValue()); break;
                	case 136: dataObj.setCBProducerFee(cellObj.getStringCellValue()); break;
                	case 137: dataObj.setPolicyNo(cellObj.getStringCellValue()); break;
